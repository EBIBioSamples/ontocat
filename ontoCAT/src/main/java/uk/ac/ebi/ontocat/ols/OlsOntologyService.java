...
OntologyService {
	...
	public OlsOntologyService() throws OntologyServiceException {
		...
		try {
			...
			throw new OntologyServiceException("Error while connecting to the Ontology Lookup Service (OLS):" + e.getMessage (), e);
		}
	}
	...
	throws OntologyServiceException {
		...
		try {
			...
			throw new OntologyServiceException("Error while connecting the Ontology Lookup Service (OLS):" + e.getMessage (), e);
		}
	}
