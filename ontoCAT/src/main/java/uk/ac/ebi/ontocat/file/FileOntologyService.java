...
implements OntologyService {
	...
	public String makeLookupHyperlink(String termAccession) {
		try {
			...
			// TODO: Should be OntologyServiceException, but this is a checked exception and we would need a deep code review
			throw new RuntimeException ( "Error while accessing the ontology '" + getOntologyUri () + "': " + e.getMessage (), e);
		}
	}
