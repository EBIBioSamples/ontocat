...
import uk.ac.ebi.ontocat.utils.OntologyParser;
 ...
 public class OntologyParserTest {
	 ...
	 @Ignore( "Brandizi, extremely time-consuming test" )
	 @Test
	 public void testOntologyParser() throws Exception {
		 ...
		 if (op != null){
			 ...
			 for (String st : op.getTermDefinitions("CL_0000502")) {
				 System.out.println(st);
			 }
			 for (String st : op.getTermDefinitions("AA_0000502")) {
				 System.out.println(st);
			 }
			 ...
			 for (String st : op.getTermSynonyms("CL_0000502")) {
				 System.out.println(st);
			 }
			 for (String st : op.getTermSynonyms("AA_0000502")) {
				 System.out.println(st);
			 }
